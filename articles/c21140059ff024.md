---
title: "WikiリンクSSGを、AI時代のMarkdownコンパイラに作り直した話"
emoji: "🐙"
...
>
> Scrapsはドキュメンテーションをプログラミング言語のように扱います。Wikiリンク付きMarkdownが型付きのsourceとなり、読み手向けの静的サイトと、AIエージェントがshell outで扱えるJSONへとコンパイルされます。
...
LLM WikiにおけるLintは、Wikiを継続的に育てるための重要なprimitiveです。Scrapsでも、Wiki-linkの構造を検査するためのlintコマンドとrule群を用意しました。
